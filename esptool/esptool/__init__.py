...
from esptool.esptool.cmds import (
    chip_id,
    detect_chip,
    detect_flash_size,
    dump_mem,
...
from esptool.esptool.loader import DEFAULT_CONNECT_ATTEMPTS, ESPLoader, list_ports
from esptool.esptool.targets import CHIP_DEFS, CHIP_LIST, ESP32ROM
from esptool.esptool.util import (
    FatalError,
